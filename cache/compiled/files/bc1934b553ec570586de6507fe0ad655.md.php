...
return [
    ...
    'filename' => '/var/www/html/grav-admin/user/pages/03.test/04.testfromgui/default.md',
    'modified' => 1691604285,
    'size' => 5320,
    'data' => [
        'header' => [
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/user/pages/03.test/04.testfromgui/banner1.jpg" class="d-block w-100" alt="SkySkrapers"/>
                ...
                <div class="carousel-item">
                    <img src="/user/pages/03.test/04.testfromgui/banner2.jpg" class="d-block w-100" alt="Castle">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Inspiring</h5>
                ...
                <div class="carousel-item">
                    <img src="/user/pages/03.test/04.testfromgui/banner3.jpg" class="d-block w-100" alt="JungleLake">
