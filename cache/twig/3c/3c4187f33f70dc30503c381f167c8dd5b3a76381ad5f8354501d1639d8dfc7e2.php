...
{% block input %}
    ...
    {% endfor %}
{% endblock %}", "forms/fields/save-redirect/save-redirect.html.twig", "/var/www/html/csss1/user/plugins/flex-objects/admin/templates/forms/fields/save-redirect/save-redirect.html.twig");
    }
}
