...
return [
    ...
    'timestamp' => 1691599741,
    'checksum' => 'c7c165f8422fce5f7f3bbe913dfca114',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/mache' => [
                'file' => 'user/themes/mache/blueprints.yaml',
                'modified' => 1691558846
            ],
            'themes/my-theme' => [
                'file' => 'user/themes/my-theme/blueprints.yaml',
                'modified' => 1691561774
            ],
            'themes/antimatter' => [
            ...
            'themes/cleantest' => [
                'file' => 'user/themes/cleantest/blueprints.yaml',
                'modified' => 1691599700
            ],
            'themes/g5_hydrogen' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.mache.logo' => [
                ...
                'name' => 'themes.mache.logo',
                'validation' => 'loose'
            ],
            'themes.mache.left_footer' => [
                'type' => 'editor',
                'label' => 'THEME_MACHE.LEFT_FOOTER',
                'name' => 'themes.mache.left_footer',
                'validation' => 'loose'
            ],
            'themes.mache.blog_thumbnail_width' => [
                'type' => 'number',
                ...
                'name' => 'themes.mache.blog_thumbnail_width',
                'validation' => 'loose'
            ],
            'themes.mache.blog_thumbnail_height' => [
                'type' => 'number',
                ...
                'name' => 'themes.mache.blog_thumbnail_height',
                'validation' => 'loose'
            ],
            'themes.mache.default_background_image' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.mache.default_background_image',
                'validation' => 'loose'
            ],
            'themes.my-theme' => [
                'type' => '_root',
            ...
            'themes.my-theme.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.my-theme.dropdown',
                'form_field' => false
            ],
            'themes.my-theme.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.my-theme.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.antimatter' => [
                'type' => '_root',
            ...
            'themes.cleantest.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.cleantest.dropdown',
                'form_field' => false
            ],
            'themes.cleantest.dropdown.enabled' => [
                'type' => 'toggle',
                'label' => 'Dropdown in Menu',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.cleantest.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.g5_hydrogen' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'mache' => [
                    'favicon' => 'themes.mache.favicon',
                    'logo' => 'themes.mache.logo',
                    'left_footer' => 'themes.mache.left_footer',
                    'blog_thumbnail_width' => 'themes.mache.blog_thumbnail_width',
                    'blog_thumbnail_height' => 'themes.mache.blog_thumbnail_height',
                    'default_background_image' => 'themes.mache.default_background_image'
                ],
                'my-theme' => [
                    'dropdown' => [
                        'enabled' => 'themes.my-theme.dropdown.enabled'
                    ]
                ],
                'antimatter' => [
                    'dropdown' => [
                ...
                'cleantest' => [
                    'dropdown' => [
                        'enabled' => 'themes.cleantest.dropdown.enabled'
                    ]
                ],
